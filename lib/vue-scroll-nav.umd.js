...
// Module
exports.push([module.i, ".scroll-nav .nav-bar{margin:0;padding:0;line-height:3.1;vertical-align:middle;border-radius:5px;-webkit-box-shadow:0 1px 8px 4px rgba(0,0,0,.02);box-shadow:0 1px 8px 4px rgba(0,0,0,.02);background:#fff}.scroll-nav .nav-bar:after{display:inline-block;content:\"\";height:100%;width:0;vertical-align:middle}.scroll-nav .nav-bar li{display:inline-block;padding:0 16px;cursor:pointer}.scroll-nav .nav-bar li.is-active{color:#387af6;border-bottom:2px solid #387af6}.scroll-nav .nav-bar.is-fixed{position:fixed;width:calc(100vw - 432px);z-index:99999;border-bottom-left-radius:0;border-bottom-right-radius:0}", ""]);
// Exports
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"scroll-nav"},[_c('div',{staticClass:"nav-bar-wrap",style:({height: _vm.navHeight, width: _vm.navWidth})},[_c('ul',{staticClass:"nav-bar",class:{'is-fixed': _vm.navBarFixed},style:({
            ...
            })},_vm._l((_vm.navMenu),function(item,index){return _c('li',{key:item.value,class:{'is-active': item.checked},on:{"click":function($event){return _vm.selectNav(item, index)}}},[_vm._v(" "+_vm._s(item.label)+" ")])}),0)]),_vm._t("default")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/src/index.vue?vue&type=template&id=1af64b32&
