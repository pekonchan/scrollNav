(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-scroll-nav"] = factory();
	else
		root["vue-scroll-nav"] = factory();
...
// Module
exports.push([module.i, ".scroll-nav .nav-bar{margin:0;padding:0;line-height:3.5;font-size:14px;vertical-align:middle;border-radius:5px;-webkit-box-shadow:0 1px 8px 4px rgba(0,0,0,.02);box-shadow:0 1px 8px 4px rgba(0,0,0,.02);background:#fff}.scroll-nav .nav-bar:after{display:inline-block;content:\"\";height:100%;width:0;vertical-align:middle}.scroll-nav .nav-bar li{display:inline-block;padding:0 16px;cursor:pointer;border-bottom-style:solid;border-bottom-width:2px}.scroll-nav .nav-bar.is-fixed{position:fixed;z-index:99999;border-bottom-left-radius:0;border-bottom-right-radius:0}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7a21a43f-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/src/index.vue?vue&type=template&id=10a4fce2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"scroll-nav"},[_c('div',{staticClass:"nav-bar-wrap",style:({height: _vm.navHeight, width: _vm.navWidth})},[_c('ul',{staticClass:"nav-bar",class:{'is-fixed': _vm.navBarFixed},style:({
                top: _vm.navTop,
                right: _vm.navRight,
                left: _vm.navLeft,
                bottom: _vm.navBottom,
                width: _vm.navBarFixed ? _vm.navFixedWidth : _vm.navWidth,
                height: _vm.navBarFixed ? _vm.navFixedHeight : '100%'
            })},_vm._l((_vm.navMenu),function(item,index){return _c('li',{key:item.value,style:({color: _vm.getNavColor(item), borderBottomColor: _vm.getNavColor(item, 'border')}),on:{"click":function($event){return _vm.selectNav(item, index)}}},[_vm._v(" "+_vm._s(item.label)+" ")])}),0)]),_vm._t("default")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/src/index.vue?vue&type=template&id=10a4fce2&
...
/* harmony default export */ var srcvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    navMenu: function navMenu() {
      ...
      return this.menu.map(function (item) {
        _this.$set(item, 'checked', item.checked || false);
    ...
    navFixedHeight: function navFixedHeight() {
      var height = this.fixedHeight ? this.fixedHeight : this.height;
      return this.createValue(height);
    },
    // 导航栏固定之后的宽度，如果没有设置指定宽度，那么默认是用未固定前的导航栏width
    navFixedWidth: function navFixedWidth() {
      var width = this.fixedWidth ? this.fixedWidth : this.width;
    ...
    navStickyTop: function navStickyTop() {
      var value = this.stickyTop ? this.stickyTop : this.top;
      return this.createValue(value);
    },
    navStickyLeft: function navStickyLeft() {
      var value = this.stickyLeft ? this.stickyLeft : this.left;
      return this.createValue(value);
    },
    navStickyRight: function navStickyRight() {
      var value = this.stickyRight ? this.stickyRight : this.right;
      return this.createValue(value);
    },
    navStickyBottom: function navStickyBottom() {
      var value = this.stickyBottom ? this.stickyBottom : this.bottom;
      return this.createValue(value);
    },
    // 根据是否需要导航栏固定的条件下，区分生成滚动导航的偏差值，如果没设置extraScroll，默认用extraFixed
    scrollDeviation: function scrollDeviation() {
      var extra = this.extraScroll ? this.extraScroll : this.extraFixed;
  ...
  methods: {
    createValue: function createValue(value) {
      return typeof value === 'number' ? "".concat(value, "px") : value;
    },
    getNavColor: function getNavColor(nav, type) {
     ...
     * 选择标题跳到对应内容
     */
    selectNav: function selectNav(nav, index) {
      this.resetNavSelect();
      nav.checked = true;
      this.scrollContainer.scrollTop = this.offsetTops["content".concat(index)] - this.scrollDeviation;
    },
    resetNavSelect: function resetNavSelect() {
      this.navMenu.forEach(function (item) {
        item.checked = false;
      });
    },
    ...
    handleScroll: function handleScroll() {
      var top = this.scrollContainer.scrollTop; // 这是用来判断目前滚动在于哪个导航上的值，对滚动容器scrollTop做了偏差值处理

      var fixedBaseTop = top + this.scrollDeviation;
      var menuLength = this.navMenu.length;
      ...
      this.resetNavSelect(); // 滚动条到达底部就选中最后一个导航
      ...
      for (var i = 0; i < menuLength - 1; i++) {
        if (fixedBaseTop >= this.offsetTops["content".concat(i)] && fixedBaseTop < this.offsetTops["content".concat(i + 1)]) {
          this.navMenu[i].checked = true;
          return;
        }
      }

      if (fixedBaseTop >= this.offsetTops["content".concat(menuLength - 1)]) {
        this.navMenu[menuLength - 1].checked = true;
        return;
      }
     ...
     */
    calcTop: function calcTop(recalNav) {
      var _this2 = this;

      this.$nextTick(function () {
        recalNav && (_this2.offsetTops.navBar = document.querySelector('.scroll-nav .nav-bar-wrap').offsetTop);

        _this2.navMenu.forEach(function (item, index) {
          _this2.offsetTops["content".concat(index)] = _this2.$slots.default[index].elm.offsetTop;
        });
      });
    },
    hanldeResize: function hanldeResize() {
      this.calcTop(true);
    },
     ...
     */
    calcFixedHeightPx: function calcFixedHeightPx() {
    ...
    * 检查浏览器是否支持sticky
    */
    isSupportSticky: function isSupportSticky() {
     ...
     */
    validateSticky: function validateSticky() {
      var supportStickyValue = this.isSupportSticky();

      if (supportStickyValue) {
        var navBarWrap = document.querySelector('.scroll-nav .nav-bar-wrap');
  ...
  mounted: function mounted() {
    ...
    this.scrollTarget.addEventListener('scroll', this.handleScroll); // 当浏览器大小发生变化时，重新计算各个offsetTop
...
//# sourceMappingURL=vue-scroll-nav.umd.js.map