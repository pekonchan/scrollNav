...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7a21a43f-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/src/index.vue?vue&type=template&id=41448519&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"scroll-nav"},[_c('div',{staticClass:"nav-bar-wrap",style:({height: _vm.navHeight, width: _vm.navWidth})},[_c('ul',{staticClass:"nav-bar submodule",class:{'is-fixed': _vm.navBarFixed},style:({
                top: _vm.navTop,
                right: _vm.navRight,
                left: _vm.navLeft,
                bottom: _vm.navBottom,
                width: _vm.navBarFixed ? _vm.navFixedWidth : 'auto',
                height: _vm.navBarFixed ? _vm.navFixedHeight : '100%',
                'line-height': ((_vm.height - 2) + "px")
            })},_vm._l((_vm.menu),function(item){return _c('li',{key:item.value,class:{'is-active': item.checked},on:{"click":function($event){return _vm.selectNav(item)}}},[_vm._v(" "+_vm._s(item.label)+" ")])}),0)]),_vm._t("default")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/src/index.vue?vue&type=template&id=41448519&
...
/* harmony default export */ var srcvue_type_script_lang_js_ = ({
  ...
  methods: {
     ...
     * 选择标题跳到对应内容
     */
    selectNav: function selectNav(nav) {
      this.resetNavSelect();
      nav.checked = true;
    ...
    calcTop: function calcTop(recalNav) {
      ...
      this.$nextTick(function () {
        recalNav && (_this.offsetTops.navBar = document.querySelector('.scroll-nav .nav-bar-wrap').offsetTop);

        _this.contentName.forEach(function (item, index) {
          _this.offsetTops["content".concat(index)] = document.querySelector(item).offsetTop;
        });
      });
    },
